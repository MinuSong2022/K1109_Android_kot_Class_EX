...
class MainActivity424 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("song","onCreate 호출 부분.onCrateCount 횟수 : $onCrateCount ")

    }

    override fun onStart() {
        super.onStart()
        Log.d("song","onStart 호출 부분.")
    }

    override fun onResume() {
        super.onResume()
        Log.d("song","onResume 호출 부분.")
    }

    override fun onPause() {
        super.onPause()
        Log.d("song","onPause 호출 부분.")
    }

    override fun onStop() {
        super.onStop()
        Log.d("song","onStop 호출 부분.")
    }
    ...
    override fun onRestoreInstanceState(savedInstanceState: Bundle) {
        ...
        Log.d("song","onRestoreInstanceState 호출 부분.onRestoreCount 횟수 : $data4 ")
        onRestoreCount++
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        Log.d("song","onSaveInstanceState..........")
        ...
        Log.d("song","onSaveInstanceState 호출 부분.onSaveCount 횟수 : $onSaveCount ")
        onSaveCount++
